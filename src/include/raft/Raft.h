...
public:
    ...
    RaftState reset_peers(const Configuration& new_peers);
    ...
    //int read_committed_user_log(const int64_t index, UserLog* user_log);//TODO not used
